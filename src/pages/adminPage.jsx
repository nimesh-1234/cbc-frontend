    ...
    <div className="w-full h-full bg-primary flex p-2 text-secondary">
      <div className="w-[300px] h-full bg-primary flex flex-col items-center gap-[20px]">
        <div className="flex flex-row w-[90%] h-[70px] bg-accent items-center rounded-2xl mb-[20px]">
            <img src="/logo.png" alt="CBC"  className="h-[70px] "/>
            <span className="text-white text-xl ml-">Admin Panel</span>
        </div>
        
        <Link to="/admin" className="w-[90%] flex items-center gap-2 px-2 rounded-lg">
            <FaChartLine/>
            Dashboard
        </Link>
         <Link to="/admin/orders" className="w-[90%] flex items-center gap-2 px-2 rounded-lg">
            <MdShoppingCartCheckout className="text-xl" />
            Orders
        </Link>
         <Link to="/admin/products" className="w-[90%] flex items-center gap-2 px-2 rounded-lg">
            <BsBox2Heart />
            products
        </Link>
        <Link to="/admin/users" className="w-[90%] flex items-center gap-2 px-2 rounded-lg">
            <HiOutlineUsers />
            User
        </Link>
      </div>
